...
CREATE TABLE `VM` (
  ...
  CONSTRAINT `LinkToVmNetwork` FOREIGN KEY (`ToVmNetwork`) REFERENCES `KvmBridgePort` (`i`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-12-12 23:06:18
